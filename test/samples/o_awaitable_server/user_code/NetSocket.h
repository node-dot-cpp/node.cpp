...
//#define IMPL_VERSION 5 // adding handler per socket class at any time
#define IMPL_VERSION 6 // adding handler per socket class before creating any socket instance
